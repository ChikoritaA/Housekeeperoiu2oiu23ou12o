...
// my default model query here

function get_subscription_day($plan_days){
   
 $query = $this->db->get_where('subscription_day', array('type' => $plan_days));
        return $query;
}

//custum model

function getschedule_list_desc(){

$this->db->from('job_scheduler');
