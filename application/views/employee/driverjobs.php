...
<?php if($this->session->flashdata('job_done')){ ?>
<div class="alert alert-success alert-dismissible fade show" role="alert">
<?php echo $this->session->flashdata('job_done'); ?>
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button>
</div>
<?php $this->session->unset_userdata('job_done'); } ?>
<!-- alert start -->
...
$emp_iddata  = $upcomingjobs['emp_id'];
...
$driver_id  = $getjobdata->driver;


//chk driver job assing
$chkjobisassign  = $this->Model->CountWhereRecord('job_scheduler',array('driver'=> $emp_ids));
...
//get emp data 
$getedata  = $this->Model->getData('cleanner',array('emp_id'=>$emp_iddata));
$efullname = $getedata->fullname;
