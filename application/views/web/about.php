...
<!------Don't-delete-------->
	...
	<section class="about-section">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-3">
					<div class="main-title text-center" data-aos="fade-up">
						<h2 class="mt0">About House Keepers</h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-8 col-xl-7">
					<div class="about_content">
						...
						<p>Maecenas quis viverra metus, et efficitur ligula. Nam congue augue et ex congue, sed luctus lectus congue. Integer convallis condimentum sem. Duis elementum tortor eget condimentum tempor. Praesent sollicitudin lectus ut pharetra pulvinar.</p>
					
					</div>
				</div>
				<div class="col-lg-4 col-xl-5">
					<div class="about_thumb">
					<img class="img-fluid w100" src="<?php echo base_url();?>assets/images/about-us-img.png" alt="1.jpg" data-aos="fade-left">
					</div>
				</div>
			</div>
			<div class="row mt50">
			...
			<div class="row">
				<div class="col-md-6 col-lg-4 col-xl-4" data-aos="zoom-in">
