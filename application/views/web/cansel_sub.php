...
.rs {
    ...
    background-image: url(<?php echo base_url();?>assets/cancel.jpg);
    min-height: 450px;
...
<body>
   ...
   <div class="row mx-0">
    ...
    <div class="pos">
	<h4>Success! you have successfully cancel subscription!</h4><br>
	 <a class="custom-btn" href="<?php echo base_url();?>" class="btn btn-primary">Go Back</a>
	</div>
</div>
